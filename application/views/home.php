				...
				<div class="container">
					<div class="header-left col-lg-2 w-auto pl-0">
						...
						<a href="<?= base_url() ?>index.php/home" class="logo">
							<img src="<?= base_url() ?>assets/images/logo.png" alt="Porto Logo">
						</a>
						</div>
					</div><!-- End .header-left -->
						...
						<div class="owl-carousel owl-theme dots-left">
							<div class="testimonial">
								<div class="testimonial-owner">
									<figure>
										<img src="<?= base_url() ?>assets/images/clients/client-1.jpg" alt="client">
									</figure>
							...
							<div class="testimonial">
								<div class="testimonial-owner">
									<figure>
										<img src="<?= base_url() ?>assets/images/clients/client-2.jpg" alt="client">
									</figure>
							...
							<div class="testimonial">
								<div class="testimonial-owner">
									<figure>
										<img src="<?= base_url() ?>assets/images/clients/client-3.jpg" alt="client">
									</figure>
				...
				<div class="row">
					<div class="col-lg-3 col-sm-6 pb-5 pb-sm-0">
						<div class="widget">
							...
							<div style="width: 105px;">
							<img src="<?= base_url() ?>assets/images/logo-footer.png" alt="Logo" class="m-b-3">
							</div>
